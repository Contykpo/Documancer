...
namespace Documancer.Infrastructure.Extensions
{
    public static class SerilogExtensions
    {
        public static void RegisterSerilog(this WebApplicationBuilder builder)
        {
            ...
            builder.Host.UseSerilog((context, configuration) => configuration.ReadFrom.Configuration(context.Configuration)
                    ...
                    .MinimumLevel.Override("Documancer.Server.UI.Services.Fusion.UserSessionTracker", LogEventLevel.Error)
                    .MinimumLevel.Override("Documancer.Server.UI.Services.Fusion.OnlineUserTracker", LogEventLevel.Error)
    ...
    internal class UserInfoEnricher : ILogEventEnricher
    {
        ...
        // Here we get data from HTTPContext.
        ...
        {
            logEvent.AddPropertyIfAbsent(propertyFactory.CreateProperty("UserName", _httpContextAccessor.HttpContext?.User?.Identity?.Name ?? ""));
        }
    }
}