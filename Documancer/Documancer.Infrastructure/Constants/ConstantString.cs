...
namespace Documancer.Infrastructure.Constants
{
    public static class ConstantString
    {
        public const string CONSTANTSTRINGRESOURCEID = "Documancer.Infrastructure.Resources.Constants.ConstantString";

        private static readonly ResourceManager resourceManager;

        static ConstantString()
        {
            resourceManager = new ResourceManager(CONSTANTSTRINGRESOURCEID, typeof(ConstantString).Assembly);
        }

        // For text inside UI buttons:
