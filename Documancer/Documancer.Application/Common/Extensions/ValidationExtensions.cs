...
namespace Documancer.Application.Common.Extensions
{
    public static class ValidationExtensions
    {
        ...
        {
            return failures != null && failures.Any() ? failures.GroupBy(e => e.PropertyName, e => e.ErrorMessage).ToDictionary(g => g.Key, g => g.ToArray()) : new Dictionary<string, string[]>();
        }
    }
}