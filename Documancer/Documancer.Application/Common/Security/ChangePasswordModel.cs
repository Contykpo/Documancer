...
namespace Documancer.Application.Common.Security
{
    ...
    public class ChangePasswordModelValidator : AbstractValidator<ChangePasswordModel>
    {
        ...
        public ChangePasswordModelValidator(IIdentitySettings identitySettings, IStringLocalizer<ApplicationUserDtoValidator> localizer)
        {
            ...
            RuleFor(x => x.ConfirmPassword).Equal(x => x.NewPassword).WithMessage(_localizer["Confirm password must match the new password"]);
        }
