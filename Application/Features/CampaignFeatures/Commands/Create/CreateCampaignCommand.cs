...
namespace Application.Features.CampaignFeatures.Commands.Create
{
    ...
    public record CreateCampaignCommand(string Name, string Description, string OwnerEmailAddress, string? FileName = null, string? ContentType = null, byte[]? Data = null) : IRequest<Guid>;
}